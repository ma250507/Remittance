...
Imports System.Text
Imports System.IO
Public Class NCRCrypto
    Private Const KeyStr As String = "Mohssen Essam Am"
    Private Const IVStr As String = " eT3eT3 "
    Private mvKey As String = "Mohssen Essam Am"
    Private mvIV As String = " eT3eT3 "
    ...
    ''    End Set
    ''End Property
    Public Function eT3_Encrypt(ByVal pData As String) As String
        ...
        End Try
    End Function
    Public Function eT3_Decrypr(ByVal eData As String) As String
