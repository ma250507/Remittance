...
Partial Class Deposit
    ...
    Protected Sub Btn_Submit_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Btn_Submit.Click
        ...
        If (DepMobileTxt.Text = "" Or BenMobileTxt.Text = "" Or AmountTxt.Text = "" Or DepositorIdTXT.Text = "" Or ConBenMobileTxt.Text = "" Or ConDepMobileTxt.Text = "") Then
        ...
        Try
            ...
            Tran.RequestType = "01"
            Tran.ResponseCode = Tran.Spaces("", 5)
            ...
            Tran.BeneficiaryMobile = Tran.Spaces(BenMobileTxt.Text, 20)
            ...
            Tran.SMSLang = Tran.Spaces(drpd_SMSLang.SelectedValue, 1)
            ...
            Tran.ID = Tran.Spaces(DepositorIdTXT.Text, 50)
        ...
        Try
            ...
            ElseIf (rtrn = 0) Then
                ...
                Tran.HostTransactionCode = Tran.Spaces(trxCodetxt.Value, 20)
                Tran.ID = Tran.Spaces("", 50)
        ...
        Catch ex As Exception
            ...
            Lbl_Status.Visible = True
        End Try
        '        Btn_Submit.Attributes.Add("Display", "none")
        Btn_Submit.Visible = False
    End Sub
    Private Function PrepareCommands(ByVal MyTrx As TRX) As Integer
        ...
        Catch ex As Exception
            Lbl_Status.Text = "Error While Creating Error Codes Description"
            Btn_Submit.Attributes.Add("Display", "inline")
        End Try
        ...
        Try
            ...
            ipAddress = ipAddress.Parse(Session("ServiceIP")) 'ipAddress.Parse("192.168.1.106")  'ipAddress.Parse(CStr(ViewState("MyIP"))) 
    ...
    Public Function ViewRcpt() As Integer
        ...
        'Catch ex As Exception
        '    Lbl_Status.Text = "Error while connecting to the database."
        '    Lbl_Status.Visible = True
        'End Try
        'Try
        '    While (Dr.Read())
        ...
        '    End While
        'Catch ex As Exception
        '    Lbl_Status.Text = "Error while reading Receipt lines from bank database."
        '    Lbl_Status.Visible = True
        'End Try
    ...
    Public Sub PrepareDT(ByVal Reply As String)
        Try
            ...
            'Dt.WriteXmlSchema(System.AppDomain.CurrentDomain.BaseDirectory & "\DepositRec.xml")
            ...
            DT_Dr("TransactionSequenceNumber") = Reply.Substring(49, 10) 'CStr(ViewState("Trxsequence"))
        ...
        Catch ex As Exception
            Lbl_Status.Text = "Error while Creating Receipt."
            Lbl_Status.Visible = True
        End Try
